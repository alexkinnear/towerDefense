...
ParticleSystem = function(spec) {
    'use strict';
    let nextName = 1;       // Unique identifier for the next particle
    let particles = {};
    let duration = spec.duration;
    let timeEmitting = 0;
    let avgLifetime = spec.lifetime.mean + spec.lifetime.stdev;
    ...
    let api = {
        ...
        get timeEmitting() { return timeEmitting; },
        get avgLifetime() { return avgLifetime; }
    };
